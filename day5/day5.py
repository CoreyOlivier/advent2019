...
def op7(prog, position, modes):
    try:
        if modes['mode0'] and modes['mode1'] == 'position':
            if modes['mode2'] == 'position':
                if prog[prog[position + 1]] < prog[prog[position + 2]]:
                ...
                if prog[prog[position + 1]] < prog[prog[position + 2]]:
                    ...
                    prog[position + 3] = 0
        elif modes['mode0'] and modes['mode1'] == 'immediate':
            if modes['mode2'] == 'position':
                if prog[position + 1] < prog[position + 2]:
                    prog[prog[position + 3]] = 1
                else:
                    prog[prog[position + 3]] = 0
            else:
                if prog[prog[position + 1]] < prog[prog[position + 2]]:
                    ...
                    prog[position + 3] = 0
        elif modes['mode0'] == 'position 'and modes['mode1'] == 'immediate':
            if modes['mode2'] == 'position':
                if prog[prog[position + 1]] < prog[position + 2]:
                    prog[prog[position + 3]] = 1
                else:
                    prog[prog[position + 3]] = 0
            else:
                if prog[prog[position + 1]] < prog[prog[position + 2]]:
                    ...
                    prog[position + 3] = 0
        elif modes['mode0'] == 'immediate'and modes['mode1'] == 'position':
            if modes['mode2'] == 'position':
                if [prog[position + 1]] < prog[prog[position + 2]]:
                    prog[prog[position + 3]] = 1
                else:
                    prog[prog[position + 3]] = 0
            else:
        ...
        print('error op7 at position: ' + str(position))
...
def op8(prog, position, modes):
    try:
        ...
        print('error op8 at position: ' + str(position))
...
#            print(prog[position], prog[position + 1],
#                    prog[position + 2], prog[position +3])
            prog, position = new_op7(prog, position, modes)
        elif op == '08':
#            print(prog[position], prog[position + 1],
#                    prog[position + 2], prog[position +3])
            prog, position = new_op8(prog, position, modes)
...
def new_op7(prog, position, modes):
    try:
        if modes['mode0'] == 'position':
...
def new_op8(prog, position, modes):
    try:
        if modes['mode0'] == 'position':
            value1 = prog[prog[position + 1]]
            if modes['mode1'] == 'position':
